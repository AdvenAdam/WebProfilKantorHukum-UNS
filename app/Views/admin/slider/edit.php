                            ...
                            <div class="col-12">
                                ...
                                <form action="/Admin/Slider/update/<?= $slider['id']; ?>" method="Post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="text" value="<?= old('judul') ? old('judul') : $slider['judul']; ?>" name="judul" class="form-control <?= $validation->hasError('judul') ? 'is-invalid' : '' ?>" id="judul" placeholder="judul">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="text" value="<?= old('link') ? old('link') : $slider['link']; ?>" name="link" class="form-control" id="link" placeholder="link">
                                    ...
                                    <div class="row mb-4">
                                        <div class="row">
                                            <div class="col-3" style="margin: 0px auto;">
                                                <img class="img-thumbnail img-preview" src="/image/slider/<?= $slider['foto']; ?>">
                                            </div>
                                        </div>
                                        <label for="foto" class="form-label"><?= $slider['foto']; ?></label>
